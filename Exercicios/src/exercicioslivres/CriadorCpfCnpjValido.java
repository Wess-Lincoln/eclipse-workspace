...
public class CriadorCpfCnpjValido {
		...
		public String cpf(boolean comPontos) {
			...
			int n8 = randomiza(n);
			int n9 = randomiza(n);
			int d1 = n9 * 2 + n8 * 3 + n7 * 4 + n6 * 5 + n5 * 6 + 
			...
			int d2 = d1 * 2 + n9 * 3 + n8 * 4 + n7 * 5 + n6 * 6 + n5 * 7 + 
		...
		public String cnpj(boolean comPontos) {
			...
			int d2 = d1 * 2 + n12 * 3 + n11 * 4 + n10 * 5 + n9 * 6 + n8 * 7 + 
					n7 * 8 + n6 * 9 + n5 * 2 + n4 * 3 + n3 * 4 + 
					n2 * 5 + n1 * 6;
		...
		public static void main(String[] args) {
			CriadorCpfCnpjValido gerador = new CriadorCpfCnpjValido();
		...
		public boolean isCPF(String CPF) {
			...
			// considera-se erro CPF's formados por uma 
